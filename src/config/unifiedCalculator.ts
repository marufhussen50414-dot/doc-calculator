...
export const UNIFIED_CALCULATOR = {
  fields: [
...

    {
      ...
      label: 'IMPON. CONTRIBUTIVO ANNO',
      category: 'CONTRIBUTIONS',
    },
    {
      id: 'contributi_anno',
      label: 'CONTRIBUTI ANNO',
      category: 'CONTRIBUTIONS',
    },
    {
      id: 'impon_contributivo_mese',
      label: 'IMPON. CONTRIBUTIVO MESE',
      category: 'CONTRIBUTIONS',
    },
    {
      id: 'impon_contrib_arrot_mese',
      label: 'IMPON. CONTRIB. ARROT. MESE',
      category: 'CONTRIBUTIONS',
    },
    {
      id: 'totale_contributi',
      label: 'TOTALE CONTRIBUTI',
      category: 'CONTRIBUTIONS',
    },
    {
      id: 'imponibile_fiscale_mese',
      label: 'IMPONIBILE FISCALE (MONTHLY)',
      category: 'TAXES - MONTHLY',
    },
    {
      id: 'irpef_lorda_mese',
      label: 'IRPEF LORDA (MONTHLY)',
      category: 'TAXES - MONTHLY',
    },
    {
      id: 'detr_lav_dipendente_mese',
      label: 'DETR. LAV. DIPENDENTE (MONTHLY)',
      category: 'TAXES - MONTHLY',
    },
    {
      id: 'detr_coniuge_mese',
      label: 'DETR. CONIUGE (MONTHLY)',
      category: 'TAXES - MONTHLY',
    },
    {
      id: 'detr_figli_mese',
      label: 'DETR. FIGLI (MONTHLY)',
      category: 'TAXES - MONTHLY',
    },
    {
      id: 'detr_altri_familiari_mese',
      label: 'DETR. ALTRI FAMILIARI (MONTHLY)',
      category: 'TAXES - MONTHLY',
    },
    {
      id: 'detr_oneri_mese',
      label: 'DETR. ONERI (MONTHLY)',
      category: 'TAXES - MONTHLY',
    },
    {
      id: 'irpef_netta_mese',
      label: 'IRPEF NETTA (MONTHLY)',
      category: 'TAXES - MONTHLY',
    },
    {
      id: 'irpef_imp_sost',
      label: 'IRPEF + IMP. SOST.',
      category: 'TAXES - MONTHLY',
    },
    {
    ...
    },
    {
      ...
      label: 'IMPONIBILE FISCALE (ANNO)',
      category: 'TAXES - ANNUAL',
    },
    {
      id: 'irpef_lorda_anno',
      label: 'IRPEF LORDA (ANNO)',
      category: 'TAXES - ANNUAL',
    },
    {
      id: 'detr_lav_dipendente_anno',
      label: 'DETR. LAV. DIPENDENTE (ANNO)',
      category: 'TAXES - ANNUAL',
    },
    {
      id: 'detr_coniuge_anno',
      label: 'DETR. CONIUGE (ANNO)',
      category: 'TAXES - ANNUAL',
    },
    {
      id: 'detr_figli_anno',
      label: 'DETR. FIGLI (ANNO)',
      category: 'TAXES - ANNUAL',
    },
    {
      id: 'detr_altri_familiari_anno',
      label: 'DETR. ALTRI FAMILIARI (ANNO)',
      category: 'TAXES - ANNUAL',
    },
    {
      id: 'detr_oneri_canoni_anno',
      label: 'DETR. ONERI/CANONI (ANNO)',
      category: 'TAXES - ANNUAL',
    },
    {
      id: 'irpef_netta_anno',
      label: 'IRPEF NETTA (ANNO)',
      category: 'TAXES - ANNUAL',
    },
    {
      id: 'irpef_trattenuta',
