...
export const UNIFIED_CALCULATOR = {
  fields: [
    { id: 'impon_contributivo_anno', label: '1. IMPON. CONTRIBUTIVO ANNO', category: 'Contributions' },
    { id: 'contributi_anno', label: '2. CONTRIBUTI ANNO', category: 'Contributions' },
    { id: 'impon_contributivo_mese', label: '3. IMPON. CONTRIBUTIVO MESE', category: 'Contributions' },
    { id: 'impon_contrib_arrot_mese', label: '4. IMPON. CONTRIB. ARROT. MESE', category: 'Contributions' },
    { id: 'totale_contributi', label: '5. TOTALE CONTRIBUTI', category: 'Contributions' },
    { id: 'imponibile_fiscale_mese', label: '6. IMPONIBILE FISCALE (Monthly)', category: 'Taxes - Monthly' },
    { id: 'irpef_lorda_mese', label: '7. IRPEF LORDA (Monthly)', category: 'Taxes - Monthly' },
    { id: 'detr_lav_dipendente_mese', label: '8. DETR. LAV. DIPENDENTE (Monthly)', category: 'Taxes - Monthly' },
    { id: 'detr_coniuge_mese', label: '9. DETR. CONIUGE (Monthly)', category: 'Taxes - Monthly' },
    { id: 'detr_figli_mese', label: '10. DETR. FIGLI (Monthly)', category: 'Taxes - Monthly' },
    { id: 'detr_altri_familiari_mese', label: '11. DETR. ALTRI FAMILIARI (Monthly)', category: 'Taxes - Monthly' },
    { id: 'detr_oneri_mese', label: '12. DETR. ONERI (Monthly)', category: 'Taxes - Monthly' },
    { id: 'irpef_netta_mese', label: '13. IRPEF NETTA (Monthly)', category: 'Taxes - Monthly' },
    { id: 'irpef_imp_sost', label: '14. IRPEF + IMP. SOST.', category: 'Taxes - Monthly' },
    { id: 'imposta_sostitutiva_mese', label: 'IMPOSTA SOSTITUTIVA (Monthly)', category: 'Taxes - Monthly' },
    { id: 'imponibile_fiscale_anno', label: '15. IMPONIBILE FISCALE (Anno)', category: 'Taxes - Annual' },
    { id: 'irpef_lorda_anno', label: '16. IRPEF LORDA (Anno)', category: 'Taxes - Annual' },
    { id: 'detr_lav_dipendente_anno', label: '17. DETR. LAV. DIPENDENTE (Anno)', category: 'Taxes - Annual' },
    { id: 'detr_coniuge_anno', label: '18. DETR. CONIUGE (Anno)', category: 'Taxes - Annual' },
    { id: 'detr_figli_anno', label: '19. DETR. FIGLI (Anno)', category: 'Taxes - Annual' },
    { id: 'detr_altri_familiari_anno', label: '20. DETR. ALTRI FAMILIARI (Anno)', category: 'Taxes - Annual' },
    { id: 'detr_oneri_canoni_anno', label: '21. DETR. ONERI/CANONI (Anno)', category: 'Taxes - Annual' },
    { id: 'irpef_netta_anno', label: '22. IRPEF NETTA (Anno)', category: 'Taxes - Annual' },
    { id: 'irpef_trattenuta', label: '23. IRPEF TRATTENUTA', category: 'Taxes - Annual' },
    { id: 'irpef_conguaglio', label: '24. IRPEF CONGUAGLIO', category: 'Taxes - Annual' },
    { id: 'retribuzione_utile_tfr', label: '25. RETRIBUZIONE UTILE TFR', category: 'TFR' },
    { id: 'contr_agg_tfr', label: '26. CONTR. AGG. TFR', category: 'TFR' },
    { id: 'tfr_mese', label: '27. TFR MESE', category: 'TFR' },
    { id: 'tfr_annuo_progr', label: '28. TFR ANNUO PROGR.', category: 'TFR' },
    { id: 'f_do_tfr_ap', label: '29. F.DO TFR 31/12 AP', category: 'TFR' },
    { id: 'anticipazioni_anno', label: '30. ANTICIPAZIONI ANNO', category: 'TFR' },
    { id: 'tfr_spettante_azienda', label: '31. TFR SPETTANTE AZIENDA', category: 'TFR' },
    { id: 'tfr_fdo_pensione', label: '32. TFR A F.DO PENSIONE', category: 'TFR' },
    { id: 'totale_competenze', label: '33. TOTALE COMPETENZE', category: 'Earnings' },
    { id: 'totale_trattenute', label: '34. TOTALE TRATTENUTE', category: 'Deductions' },
    { id: 'arr_preced', label: '35. ARR. PRECED.', category: 'Adjustments' },
    { id: 'arr_attuale', label: '36. ARR. ATTUALE', category: 'Adjustments' },
    { id: 'netto_busta', label: '37. NETTO IN BUSTA', category: 'Net Pay' }
  ] as CalculatorField[],
