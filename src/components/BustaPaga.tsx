...
const CUSTOM_FIELD_TITLES: Record<string, string> = {
  ...
  '5_imponibile_contributivo_anno': 'গত মাসের IMPON. CONTRIBUTIVO ANNO + চলতি মাসের IMPON. CONTRIBUTIVO MESE:',
  'imponibile_contributivo_anno': 'গত মাসের IMPON. CONTRIBUTIVO ANNO + চলতি মাসের IMPON. CONTRIBUTIVO MESE:',
  '5_impon_contributivo_anno': 'গত মাসের IMPON. CONTRIBUTIVO ANNO + চলতি মাসের IMPON. CONTRIBUTIVO MESE:',
...
export const BustaPaga: React.FC<BustaPagaProps> = ({ onBack }) => {
  ...
  const isAnnuoField = (fieldId: string | null): boolean => {
    ...
    const isImponibileContributivoAnno = lower.includes('imponibile_contributivo_anno') || lower.includes('impon_contributivo_anno') || label.includes('impon. contributivo anno') || label.includes('5. impon. contributivo');
    ...
    return isImponibileContributivoAnno || isContributiAnno || isTfrAnnuo || isDetrLavDipAnno || isImponibileFiscaleAnno;
  };
