    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="mt-4 border-t border-amber-200 pt-4">
              ...
              <div className="space-y-2 text-xs font-mono">
                <div className="bg-white p-2.5 rounded border border-gray-200">
                  ...
                  <div className="text-gray-900 mt-1">IRPEF + IMP. SOST. = TOTALE TRATTENUTE - TOTALE CONTRIBUTI - ADDIZIONALI</div>
                </div>

                <div className="bg-white p-2.5 rounded border border-gray-200">
                  <span className="font-semibold text-gray-700">To calculate TOTALE CONTRIBUTI:</span>
                  <div className="text-gray-900 mt-1">TOTALE CONTRIBUTI = TOTALE TRATTENUTE - (IRPEF + IMP. SOST.) - ADDIZIONALI</div>
                </div>

                <div className="bg-white p-2.5 rounded border border-gray-200">
                  <span className="font-semibold text-gray-700">To calculate ADDIZIONALI:</span>
                  <div className="text-gray-900 mt-1">ADDIZIONALI = TOTALE TRATTENUTE - (IRPEF + IMP. SOST.) - TOTALE CONTRIBUTI</div>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Formula 5 (IRPEF LORDA Calculation) & Sub-formulas */}
          ...
          {/* Formula 7 (IRPEF NETTA Calculation) & Sub-formulas */}
          <div className="bg-gradient-to-r from-violet-50 to-fuchsia-50 border-2 border-violet-200 rounded-lg p-6">
            ...
            <div className="mt-4 border-t border-violet-200 pt-4">
              ...
              <div className="space-y-2 text-xs font-mono">
                <div className="bg-white p-2.5 rounded border border-gray-200">
                  <span className="font-semibold text-gray-700">To calculate IRPEF LORDA:</span>
                  <div className="text-gray-900 mt-1">IRPEF LORDA = IRPEF NETTA (Monthly) + DETR. LAV. DIPENDENTE</div>
                </div>
